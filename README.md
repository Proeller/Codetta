...
C# programmers usually work with Microsoft Visual Studio which comes with the Consolas font designed by [Luc de Groot] (https://en.wikipedia.org/wiki/Luc(as)_de_Groot). 
